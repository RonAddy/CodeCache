class User < ApplicationRecord
	...
	# allow nil for user input that does not need password input
	...
	# Self in method declaration refers to the class 
	# will check if the username is true first
	# then will check if password attempt is equal to password_diget for user
